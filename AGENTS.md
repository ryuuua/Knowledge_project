...
bash /Users/ryua/code/mcp_sandbox/scripts/factory_auto.sh \
  --token <TOKEN> \
  --repo-id Knowledge_project \
  --repo-name Knowledge_project \
...
実行例:
- `python3 /Users/ryua/code/mcp_sandbox/scripts/dispatch_repo_trigger.py --repo-root /Users/ryua/code/Knowledge_project --token <TOKEN>`
