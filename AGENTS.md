...
- Sandbox automation: `bash /Users/ryua/code/mcp_sandbox/scripts/factory_auto.sh --token <TOKEN> --repo-id Knowledge_project --repo-name Knowledge_project --branch "$(git rev-parse --abbrev-ref HEAD)"`
